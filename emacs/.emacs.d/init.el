...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (phpcbf company-php php-eldoc json-mode prettier-js company-tern tern geiser hy-mode lsp-python ob-restclient company-restclient restclient multi-term exec-path-from-shell editorconfig company-lsp lsp-ui lsp-mode ac-core-php all-the-icons anzu better-defaults company counsel doom-modeline doom-themes dumb-jump evil evil-collection evil-magit evil-surround eyebrowse flycheck general git-timemachine haskell-mode htmlize hydra ivy js2-mode keyfreq magit magithub olivetti omnisharp org-bullets ox-pandoc paradox paredit php-mode pipenv projectile racket-mode rainbow-delimiters rainbow-mode restart-emacs rjsx-mode slime smartparens solaire-mode stumpwm-mode swiper tide treemacs treemacs-evil treemacs-projectile typescript-mode use-package use-package-ensure-system-package vi-tilde-fringe web-mode which-key yasnippet-classic-snippets yasnippet-snippets)))
