...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package nord-theme
    :ensure t
    :config
    (add-to-list 'custom-theme-load-path "/home/kevin/projects/nord-emacs/")
...
#+BEGIN_SRC emacs-lisp
  (use-package telephone-line
    ...
    (defface my-line-evil-operator
      '((t (:background "#a9a1e1" :inherit my-line-evil)))
    ...
    ;; (telephone-line-evil-normal (:inherit 'telephone-line-evil :background "black" :foreground "white"))
    ...
    (setq telephone-line-faces
          '((evil . my-evil-face)
            ...
            (nil my-line-active . mode-line-inactive)))
      ...
      (when (and (buffer-modified-p) (not (member mode-name modeline-ignored-modes)) (not buffer-read-only))
        (format "%s "
                (propertize (all-the-icons-faicon "pencil")
                            'face `(:height 1.0 :foreground "#DDC085")
                            'display '(raise 0.0)))))
