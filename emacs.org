...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (my-leader-def
      ...
      "w1" 'eyebrowse-switch-to-config-1
      "w2" 'eyebrowse-switch-to-config-2
      "w3" 'eyebrowse-switch-to-config-3
      "w4" 'eyebrowse-switch-to-config-4
      "w4" 'eyebrowse-switch-to-config-4
      "w5" 'eyebrowse-switch-to-config-5
      "w6" 'eyebrowse-switch-to-config-6
      "w7" 'eyebrowse-switch-to-config-7
      "w8" 'eyebrowse-switch-to-config-8
      "w9" 'eyebrowse-switch-to-config-9
      "w0" 'eyebrowse-switch-to-config-0
      ;; magit
      "gs" 'magit-status
      "gc" 'magit-checkout
      "gC" 'magit-commit
