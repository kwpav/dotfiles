...
Use =org-mode= for the scratch buffer and remove the default message.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;                           (projects . 5)
  ;;                           (agenda . 5)))
  ;;   (add-hook 'dashboard-mode-hook (lambda () (turn-on-page-break-lines-mode)))
  ;;   :config
  ;;   (dashboard-setup-startup-hook))
#+END_SRC
start off with the scratch buffer instead
#+BEGIN_SRC emacs-lisp
...
largely taken from http://doc.norang.ca/org-mode.html
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-todo-keyword-faces
          (quote (("TODO" :foreground "#D95468" :weight bold)
                  ("NEXT" :foreground "#5EC4FF" :weight bold)
...
** hugo
set up =ox-hugo= to use =org-mode= in hugo!
