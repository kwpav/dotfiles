    ...
    (defun my-evil-face (active)
      ...
      (setq modeline-ignored-modes '("Warnings"
       ...
       (telephone-line-defsegment my-buffer-segment ()
         "Display the path to the current file if in a project"
             ...
             (format "%s" (propertize
                           (concat
                            (telephone-line--truncate-path
                             (abbreviate-file-name (file-name-directory (directory-file-name (projectile-project-root)))) 1) ;; the path to the project
...
- telephone-line segments [0/6]
  + [ ] current file - display folder name(s)
  + [ ] fix colors
  + [ ] git
  + [ ] eyebrowse
  + [ ] anzu
